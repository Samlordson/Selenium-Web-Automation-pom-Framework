...
public class CreateChangeStudyRequestchanges extends Base {

    public CreateChangeStudyRequestchanges(RemoteWebDriver driver) {
        this.driver = driver;
    }
    ...
    private By submitButton = By.xpath("//button[normalize-space(text())='Submit']");

    // 🔹 Actions
    
    public CreateChangeStudyRequestchanges clickcreatenewrequest() {
        try {
    ...
    public CreateChangeStudyRequestchanges setDateReceived(String date) {
        try {
    ...
    public CreateChangeStudyRequestchanges selectBusiness(String businessName) {
        try {
    ...
    public CreateChangeStudyRequestchanges selectOriginatingParty(String partyName) {
        try {
    ...
    public CreateChangeStudyRequestchanges enterRequestedBy(String requester) {
        try {
    ...
    public CreateChangeStudyRequestchanges selectProjectArea(String area) {
        try {
    ...
    public CreateChangeStudyRequestchanges enterOtherProjectArea(String text) {
        try {
    ...
    public CreateChangeStudyRequestchanges enterChangeDescription(String desc) {
        try {
    ...
    public CreateChangeStudyRequestchanges enterChangeReason(String reason) {
        try {
    ...
    public CreateChangeStudyRequestchanges enterAdditionalInfo(String info) {
        try {
    ...
    public CreateChangeStudyRequestchanges scrollToSubmit() {
        try {
    ...
    public CreateChangeStudyRequestchanges clickSubmit() {
        try {
